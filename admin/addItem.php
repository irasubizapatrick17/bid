...
if ($existCount > 0) { 
	...
	if(isset($_POST['addpst']))
	{
		...
		$sql = $db->query("INSERT INTO items1 (itemName, productCode, quantity, unityPrice, inDate, postedBy, itemCompanyCode, description, postDeadline) 
		VALUES ('$itemName', '$productCode', '$quantity', '$unityPrice', now(), '$postedBy', '$itemCompanyCode', '$description', '$postDeadline')")or die (mysqli_error());
